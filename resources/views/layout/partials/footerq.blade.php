            ...
            <div class="row row-50">
                <div class="col-lg-5 text-center text-sm-left">
                    <article class="unit unit-sm-horizontal unit-middle justify-content-center justify-content-sm-start footer-classic-info">
                        <div class="unit-left"><a class="brand brand-md" href="../landing"><img class="brand-logo " src="{{ asset('principal/images/logo-soccer-default-95x126.png')}}" alt="" width="95" height="126" /></a>
                        </div>
                        <div class="unit-body">
                    ...
                    <ul class="list-inline list-inline-bordered list-inline-bordered-lg">
                        <li>
                            <div class="unit unit-horizontal unit-middle">
                                ...
                                <div class="unit-body">
                                    <h6>Join Our Team</h6><a class="link" href="/cdn-cgi/l/email-protection#ab88"><span class="__cf_email__" data-cfemail="116574707c5175747c7e7d787f7a3f7e6376">[email&#160;protected]</span></a>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div class="unit unit-horizontal unit-middle">
                                ...
                                <div class="unit-body">
                                    <h6>Contact Us</h6><a class="link" href="/cdn-cgi/l/email-protection#785b"><span class="__cf_email__" data-cfemail="7910171f16391d1c14161510171257160b1e">[email&#160;protected]</span></a>
                                </div>
                            </div>
                        </li>
                    </ul>
                    ...
                    <div class="row row-20">
                        <div class="col-sm-6">
                            ...
                            <article class="post-classic">
                                <div class="post-classic-aside"><a class="post-classic-figure" href="blog-post.html"><img src="{{ asset('principal/images/footer-soccer-post-1-93x87.jpg')}}" alt="" width="93" height="87" /></a></div>
                        ...
                        <div class="col-sm-6">
                            <!-- Post Classic-->
                            <article class="post-classic">
                                <div class="post-classic-aside"><a class="post-classic-figure" href="blog-post.html"><img src="{{ asset('principal/images/footer-soccer-post-2-93x87.jpg')}}" alt="" width="93" height="87" /></a></div>
                                <div class="post-classic-main">
                                    <!-- Badge-->
                        ...
                        <div class="col-sm-6">
                            <!-- Post Classic-->
                            <article class="post-classic">
                                <div class="post-classic-aside"><a class="post-classic-figure" href="blog-post.html"><img src="{{ asset('principal/images/footer-soccer-post-3-93x87.jpg')}}" alt="" width="93" height="87" /></a></div>
                                <div class="post-classic-main">
                                    <!-- Badge-->
                        ...
                        <div class="col-sm-6">
                            <!-- Post Classic-->
                            <article class="post-classic">
                                <div class="post-classic-aside"><a class="post-classic-figure" href="blog-post.html"><img src="{{ asset('principal/images/footer-soccer-post-4-93x87.jpg')}}" alt="" width="93" height="87" /></a></div>
                                <div class="post-classic-main">
                                    <!-- Badge-->
                                    <div class="badge badge-primary">The League
                                    </div>
