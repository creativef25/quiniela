                                        ...
                                        <div class="cart-inline-inner">
                                            ...
                                            <div class="cart-inline-main">
                                                ...
                                                <article class="product-inline">
                                                    <div class="product-inline-aside"><a class="product-inline-figure" href="product-page.html"><img class="product-inline-image"
                                                              src="{{ asset('principal/images/product-Nike-Air-Zoom-Pegasus-67x30.png')}}" alt="" width="67" height="30" /></a></div>
                                                ...
                                                <!-- Product inline-->
                                                <article class="product-inline">
                                                    <div class="product-inline-aside"><a class="product-inline-figure" href="product-page.html"><img class="product-inline-image" src="{{ asset('principal/images/product-Nike-Baseball-Hat-55x38.png')}}"
                                                              alt="" width="55" height="38" /></a></div>
                                                    <div class="product-inline-main">
